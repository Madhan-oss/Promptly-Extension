# Promptly - Build Script for Opera (Manifest V3, same as Chrome)
# Creates: dist\promptly-opera-v1.2.0.zip
# Usage:   .\build-opera.ps1

$ErrorActionPreference = "Stop"

$VERSION    = "1.2.0"
$BUILD_DIR  = "dist\opera"
$ZIP_NAME   = "promptly-opera-v${VERSION}.zip"
...
Write-Host "Building Promptly for Opera v${VERSION} ..." -ForegroundColor Red
...
Write-Host ""
Write-Host "Opera build complete! -> dist\$ZIP_NAME  ($sizeKB KB)" -ForegroundColor Green
Write-Host ""
Write-Host "Upload at:" -ForegroundColor Yellow
Write-Host "  Opera Add-ons : https://addons.opera.com/developer/" -ForegroundColor Gray
